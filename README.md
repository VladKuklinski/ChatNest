...
- 🔐 User authentication (email/password, Facebook login)
- 💬 Real-time messaging
- 👥 Friends management (add/remove friends, incoming/outgoing requests)
- 🟢 Online/offline friend status tracking
